...
import { getVisibleCompanies, getFilter, getSort } from '../../selectors/companies';
...
export const Companies = ({ companies, filter, sort, sortCompanyList, filterCompanyList, handleFilterChange }) => (
  <Container>
    <Header>
      <HeaderLeft>
