...
const size2Dim = size => ({ LARGE: '52px', MEDIUM: '36px', SMALL: '28px' }[size] || '36px');
const size2Font = size => ({ LARGE: '1.2rem', MEDIUM: '1rem', SMALL: '0.8rem' }[size] || '1rem');
...
const Avatar = ({ name, color, size = SMALL, showTooltip = false, className, to = '' }) => (
  <Link to={to}>
